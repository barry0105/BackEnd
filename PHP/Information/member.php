<html>
    ...
    <body>
        <h2>▶ 회원가입</h2>
        <form action="mem_print.php" method="post" name="mem_form">
            <table border="1" width="640" cellpacing="1" cellpadding="4"></table>
            <tr>
                <td>* 아이디 :
                </td>
            ...
            <tr>
                ...
                <td><input type="text" size="15" maxlength="12" name="passwd_confirm"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="checkbox" name="movie" value="yes" checked="checked">영화감상 &nbsp;
                    <input type="checkbox" name="book" value="yes">독서 &nbsp;
                    <input type="checkbox" name="shop" value="yes">쇼핑 &nbsp;
                    <input type="checkbox" name="sport" value="yes" checked="checked">운동
                </td>
            </tr>
            <tr>
